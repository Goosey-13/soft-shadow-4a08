...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/soft-shadow-4a08)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/soft-shadow-4a08
```

A live public deployment of this template is available at [https://soft-shadow-4a08.templates.workers.dev](https://soft-shadow-4a08.templates.workers.dev)
